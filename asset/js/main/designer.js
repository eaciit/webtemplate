...
viewModel.designer.createPanel = function () {
    ...
    viewModel.ajaxPost("/designer/savepanel", param, function (res) {
        ...
        var $panel = viewModel.designer.putPanel(panelID, config.title, config.width, config.offset, config.hideContainerPanel, "prepend");
...
viewModel.designer.drawContent = function () {
    ...
    ko.mapping.toJS(viewModel.designer.config).content.forEach(function (e) {
        //~ console.log(e.hideContainerPanel);
        ...
        if (e.hideContainerPanel == true) {
            $('.grid-item[data-panel-id="'+e.panelID+'"]').css({"background-color":"transparent ","border":"0px none transparent"});
            $('.grid-item[data-panel-id="'+e.panelID+'"] .panel').css({"background-color":"transparent ","border":"0px none transparent", "border-radius":"0px","-webkit-box-shadow":"0 0 0 rgba(0,0,0,0)","box-shadow":"0 0 0 rgba(0,0,0,0)"});
            $('.grid-item[data-panel-id="'+e.panelID+'"] .panel > div').css({"background-color":"transparent ","border":"0px none transparent"});
            $('.grid-item[data-panel-id="'+e.panelID+'"] .panel .panel-config').hide();
            $('.grid-item[data-panel-id="'+e.panelID+'"] .panel').mouseover(function() {
            //~ $('.grid-item[data-panel-id="'+e.panelID+'"] .panel .panel-heading').mouseover(function() {
                $('.grid-item[data-panel-id="'+e.panelID+'"] .panel .panel-config').show();
            });
            $('.grid-item[data-panel-id="'+e.panelID+'"] .panel').mouseout(function() {
            //~ $('.grid-item[data-panel-id="'+e.panelID+'"] .panel .panel-heading').mouseout(function() {
                $('.grid-item[data-panel-id="'+e.panelID+'"] .panel .panel-config').hide();
            });
